...
class UserAccountServiceTest {
    ...
    @Test
    void givenExistUserId_whenSearching_thenReturnsOptionalUserData() {
        // Given
        String username = "uno";
    ...
    @DisplayName("존재하지 않는 회원 Id를 검색하면, 빈 Optional을 반환")
    @Test
    ...
    @DisplayName("회원 정보를 입력하면, 새로운 회원 정보를 저장하여 가입하고 해당 회원 데이터를 반환")
    @Test
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("uno");
        UserAccount saveUserAccount = createSigningUpUserAccount("uno");
    ...
    private UserAccount createUserAccount(String username, String createBy) {
