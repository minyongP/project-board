...
class ArticleCommentServiceTest {
    ...
    void givenParentCommentIdAndArticleCommentInfo_whenSaving_thenSavesChildComment() {
        ...
        // When
        articleCommentService.saveArticleComment(child);
    ...
    private ArticleCommentDto createArticleCommentDto(Long parentCommnetId,String content) {
        return createArticleCommentDto(1L, parentCommnetId, content);
    }
