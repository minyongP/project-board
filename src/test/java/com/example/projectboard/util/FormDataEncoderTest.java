...
class FormDataEncoderTest {
    ...
    static class TestObject {
        ...
        public TestObject(String str, String listStr1, String listStr2, String nullStr,
                          Integer number, Double floatingNumber, Boolean bool,
                          BigDecimal bigDecimal, TestEnum testEnum) {
            this.str = str;
        ...
        @JsonProperty("listStr1")
        public String getListStr1() {
            return listStr1;
        }

        @JsonProperty("listStr2")
